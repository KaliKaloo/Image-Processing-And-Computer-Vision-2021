...
void median(cv::Mat &input, int ksize, cv::Mat &output){
...
int main( int argc, char** argv )
{
 ...
 Mat carBlurred;
 median(gray_image, 5, carBlurred);
//  medianBlur( gray_image, carBlurred, 5);
	

 imwrite( "car2medianBlurFunction.jpg", carBlurred );
